...
export class SymptomsController {
    ...
    getSymptoms(
        ...
        // this.logger.verbose(
        //   `User "${user.username}" retrieving all tasks. Filters: ${JSON.numberify(
        //     filterDto,
        //   )}`,
        // );
    ...
    @Get('/:id')
    getSymptomById(@Param('id') id: number): Promise<Symptom> {
    ...
    createSymptom(
        ...
        // this.logger.verbose(
        //   `User "${user.username}" creating a new tasks. Data: ${JSON.numberify(
        //     createTaskDto,
        //   )}`,
        // );
    ...
    @Delete('/:id')
    deleteSymptom(@Param('id') id: number): Promise<void> {
